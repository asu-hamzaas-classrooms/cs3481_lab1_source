...
void addOverflowTests()
{
   ...
   assert(Tools::addOverflow(1, 0x7fffffffffffffff) == true);
   assert(Tools::addOverflow(1, 0x7ffffffffffffffe) == false);
   assert(Tools::addOverflow(-1, 0x8000000000000000) == true);
   assert(Tools::addOverflow(-1, 0x8000000000000001) == false);
}
...
void subOverflowTests()
{
   ...
   /* Add four more tests.  See lab directions. */
   assert(Tools::subOverflow(0x8000000000000001, 0x0000000000000001) == true);
   assert(Tools::subOverflow(0x8000000000000002, 0x0000000000000001) == false);
   assert(Tools::subOverflow(0x7fffffffffffffff, 0xfffffffffffffffe) == true);
   assert(Tools::subOverflow(0x7ffffffffffffffe, 0xfffffffffffffffe) == false);
}
